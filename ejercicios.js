...
function canBuyProduct() {
    ...
    resultado=1500 * (1 - 0.25);
    let dineroDispionible=1150;
    
    console.log(resultado <= 1150? "Puedo comprar el producto" : "No me alcanza");
}
...
function createSumVariable(a,b) {
     let resultado=2+3;
    console.log(resultado);
}
...
function checkDogIdIsString(dogId) {
    typeof dogId;String;
    console.log(dogId);
...
function logMessage() {
    ...
    console.log("Hola me llamo Delia");
}
